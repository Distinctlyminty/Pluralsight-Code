...
namespace X509Certs
{
    class Program
    {
        ...
        {
            var primaryPFX = new X509Certificate2(@"Certificates/X509CADevice1.pfx", "1234");
            var primaryAuth = new DeviceAuthenticationWithX509Certificate("X509CADevice1", primaryPFX);
